      ...
      var Engine = setInterval(function() {
        ...
        if (Status === "SendR") {
          ...
          if (location.hostname != myname.toLowerCase() + com) {
            saveTestData = "https://" + location.hostname.split('.').slice(-2).join('.') + "/results/show?" + "&d=" + downloadSpeed.toFixed(3) + "&u=" + uploadSpeed.toFixed(3) + "&p=" + pingEstimate + "&j=" + jitterEstimate + "&dd=" + (dataUsedfordl / 1048576).toFixed(3) + "&ud=" + (dataUsedforul / 1048576).toFixed(3) + "&h=" + location.hostname + "&ua=" + userAgentString;
